package com.example.subhamdivakar.simplelogin;
...
//        return EMAIL_ADDRESS_PATTERN.matcher(email).matches();
        ...
        if(h==false){
                Toast.makeText(RegisterActivity.this,"Enter valid email id as xyzq@abc.com",Toast.LENGTH_LONG).show();
       }
    ...
    public void CheckEditTextStatus(){
        ...
        if(TextUtils.isEmpty(NameHolder) || TextUtils.isEmpty(EmailHolder) || TextUtils.isEmpty(PasswordHolder)){
            ...
            if(checkEmail(EmailHolder))
            {
                EditTextEmptyHolder = true ;
            }
            else
            {
                Toast.makeText(RegisterActivity.this,"Enter valid email id as xyzq@gmail.com",Toast.LENGTH_LONG).show();
            }
